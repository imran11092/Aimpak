...
import org.AimPak.messenger.BuildVars;
import org.AimPak.android.LocaleController;
import org.AimPak.messenger.FileLoader;
import org.AimPak.messenger.SerializedData;
import org.AimPak.messenger.TLClassStore;
import org.AimPak.messenger.TLObject;
...
import org.AimPak.messenger.RPCRequest;
...
import org.AimPak.ui.Cells.TextInfoCell;
import org.AimPak.ui.Cells.EmptyCell;
import org.AimPak.ui.Cells.HeaderCell;
import org.AimPak.ui.Cells.ShadowSectionCell;
import org.AimPak.ui.Cells.TextCheckCell;
import org.AimPak.ui.Cells.TextDetailSettingsCell;
import org.AimPak.ui.Cells.TextSettingsCell;
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    try {
                        ...
                        ((TextInfoCell) view).setText(String.format(Locale.US, "AimPak for Android v%s (%d)", pInfo.versionName, pInfo.versionCode));
                    } catch (Exception e) {
                        FileLog.e("tmessages", e);
                    }
                }
