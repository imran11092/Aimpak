    ...
    private HashMap<Integer, File> createMediaPaths() {
        ...
        try {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                telegramPath = new File(Environment.getExternalStorageDirectory(), "AimPak");
                telegramPath.mkdirs();
                ...
                if (canRename) {
                    if (telegramPath.isDirectory()) {
                        ...
                        try {
                            File audioPath = new File(telegramPath, "AimPak Audio");
                            audioPath.mkdir();
                        ...
                        try {
                            File documentPath = new File(telegramPath, "AimPak Documents");
                            documentPath.mkdir();
